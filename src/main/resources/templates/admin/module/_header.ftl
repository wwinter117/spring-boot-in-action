...
<#--                    </a>-->
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <#if user??>
                            <img src="${user.userAvatar!'/static/images/default.png'}" class="user-image" alt="User Image">
                            <span class="hidden-xs">${user.userDisplayName!'Untitled'}</span>
                        </#if>
                    </a>
                    <ul class="dropdown-menu">
...
<#--                        </li>-->
                        <li class="user-header">
                            <#if user??>
                                <img src="<#if user.userAvatar??>${user.userAvatar!'/static/images/default.png'}<#else>/static/images/default.png</#if>" class="img-circle" alt="User Image">
                                <p>${user.userDisplayName!''}-${user.userDesc!''}<small></small></p>
                            </#if>
                        </li>
